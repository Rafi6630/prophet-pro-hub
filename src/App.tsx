...
// Investor pages
import DecisionHub from "@/pages/investor/DecisionHub";
import DealList from "@/pages/investor/DealList";
                ...
                <RequireRole allow={"buyer"}>
                  <Layout>
                    <Routes>
                      ...
                      <Route path="/investor/hub" element={<DecisionHub />} />
                      <Route path="/investor/deals" element={<DealList />} />
                      <Route path="/investor/deals/:id" element={<DealDetail />} />
